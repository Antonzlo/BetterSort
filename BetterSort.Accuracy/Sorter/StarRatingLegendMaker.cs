...
namespace BetterSort.Accuracy.Sorter {
  ...
  internal class StarRatingLegendMaker {

    public static List<(string, int)> GetLevelLegend(List<LevelRecord> mapping, int length) {
      ...
      for (int i = 0; i < count; i++) {
        ...
        legend.Add((record.Stars.ToString("0.00") + "★", index));
      }
