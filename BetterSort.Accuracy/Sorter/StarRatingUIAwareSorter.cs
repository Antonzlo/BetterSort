...
namespace BetterSort.Accuracy.Sorter {
  ...
  public class StarRatingUIAwareSorter : ISortFilter, IDifficultySelector {
    private readonly StarRatingSorter _sorter;
    private readonly SiraLog _logger;
    private readonly IBsInterop _bsInterop;

    public StarRatingUIAwareSorter(StarRatingSorter sorter, SiraLog logger, IBsInterop bsInterop) {
      _sorter = sorter;
      _logger = logger;
    ...
    public PlayedMap? SelectDifficulty(int index, LevelPreview preview) {
      ...
      _logger.Debug($"{nameof(SelectDifficulty)}: Set {index} {preview.SongName} {record.Mode} {record.Difficulty} {record.Stars}");
